...
[![Test](https://github.com/NpoolPlatform/basal-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/basal-manager/actions/workflows/main.yml)
...
* make basal-manager ```单独编译服务```
* make basal-manager-image ```单独生成服务镜像```
